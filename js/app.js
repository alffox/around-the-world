...
var octopus = {
    ...
    getNews: function(clickedLocationCountry, clickedLocation) {
        var errorKey = '.news';
        $.ajax({
            url: `https://liferay-aroundthewordapi.wedeploy.io/newsEndpoint?q=${clickedLocationCountry}`,
            method: "GET",
            error: function() {
    ...
    getWeather: function(clickedLocation, clickedLocationCountryCode, clickedLocationLat, clickedLocationLon) {
        ...
        $.ajax({
            url: `https://liferay-aroundthewordapi.wedeploy.io/weatherEndpoint?lat=${clickedLocationLat}&lon=${clickedLocationLon}&units=metric`,
            method: "GET",
            error: function() {
                view.renderAPIError(errorKey);
            },
    ...
    getWebCam: function(clickedLocationLat, clickedLocationLon, clickedLocationCountryCode) {
        var errorKey = ".webcam";
        $.ajax({
            url: `liferay-aroundthewordapi.wedeploy.io/webcamEndpoint?countryCode=${clickedLocationCountryCode}&lat=${clickedLocationLat}&lon=${clickedLocationLon}`,
            method: "GET",
            error: function() {
                view.renderAPIError(errorKey);
            },
    ...
    getPictures: function(clickedLocationCountry) {
        ...
        $.ajax({
            url: `liferay-aroundthewordapi.wedeploy.io/picturesEndpoint?page=${randomPageNumber}&query=${clickedLocationCountry}`,
            method: "GET",
            error: function() {
                view.renderAPIError(errorKey);
            },
