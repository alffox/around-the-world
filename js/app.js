...
var view = {
    ...
    renderNews: function(news, clickedLocationCountry, clickedLocationCountryCode) {
        ...
        for (var i = 0; i < news.articles.length; i++) {
            ...
            if (newsPicture !== null) {
                var newsHTML = ('<ul class="list-group"><li class="list-group-item list-group-item-action active d-flex justify-content-between align-items-center mt-1 m-1"><img class="lazy img-fluid img-thumbnail news-picture" data-src="' + newsPicture + '" alt="' + newsTitle + '"><a href="' + newsUrl + '" target="_blank" class="list-group-item list-group-item-action active">' + newsTitle + '</a><span class="badge badge-primary badge-pill d-none d-xl-block">' + newsSource + '</span></li></ul>');
            } else {
